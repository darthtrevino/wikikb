...
try {
  ...
  const expected = [
    ...
    `${bundleName}/vendor/lexcat/lexcat-v0.0.11-macos-arm64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.11-linux-x86_64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.11-windows-x86_64.zip`,
