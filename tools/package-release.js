...
try {
  ...
  const expected = [
    ...
    `${bundleName}/vendor/soma/manifest.json`,
    `${bundleName}/vendor/soma/THIRD_PARTY_NOTICES.txt`,
    `${bundleName}/vendor/soma/soma-v0.3.0-macos-arm64.tar.gz`,
    `${bundleName}/vendor/soma/soma-v0.3.0-linux-arm64.tar.gz`,
    `${bundleName}/vendor/soma/soma-v0.3.0-linux-x86_64.tar.gz`,
    `${bundleName}/vendor/soma/soma-v0.3.0-windows-arm64.zip`,
    `${bundleName}/vendor/soma/soma-v0.3.0-windows-x86_64.zip`,
