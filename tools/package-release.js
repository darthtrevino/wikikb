...
try {
  ...
  const expected = [
    ...
    `${bundleName}/vendor/lexcat/lexcat-v0.0.12-macos-arm64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.12-macos-x86_64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.12-linux-arm64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.12-linux-x86_64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.12-windows-x86_64.zip`,
