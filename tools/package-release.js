...
try {
  ...
  const expected = [
    ...
    `${bundleName}/vendor/lexcat/lexcat-v0.0.14-macos-arm64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.14-macos-x86_64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.14-linux-arm64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.14-linux-x86_64.tar.gz`,
    `${bundleName}/vendor/lexcat/lexcat-v0.0.14-windows-x86_64.zip`,
