...
The GitHub release attaches an allowlisted `cli-agentic-workflows` archive and SHA-256 checksum. It includes supporting source plus checksum-pinned LexCAT executables for `linux/x64`, `linux/arm64`, `darwin/arm64`, `darwin/x64`, and `win32/x64`: `lexcat-v0.0.12-linux-x86_64.tar.gz`, `lexcat-v0.0.12-linux-arm64.tar.gz`, `lexcat-v0.0.12-macos-arm64.tar.gz`, `lexcat-v0.0.12-macos-x86_64.tar.gz`, and `lexcat-v0.0.12-windows-x86_64.zip`.
